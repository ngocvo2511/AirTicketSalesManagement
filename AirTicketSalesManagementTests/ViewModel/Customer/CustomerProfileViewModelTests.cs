...
{
    [TestClass]
    public class CustomerProfileViewModelTests
    {
        ...
        {
            _viewModel = new CustomerProfileViewModel();
        }

        [TestMethod]
        public void OpenEditProfile()
        {
            _viewModel.HoTen = "Customer User";
            _viewModel.Email = "customer@test.com";
            _viewModel.SoDienThoai = "0909090909";
            _viewModel.CanCuoc = "012345678912";
            _viewModel.GioiTinh = "Nữ";
            _viewModel.NgaySinh = new DateTime(2000, 5, 20);
        ...
        public void OpenChangePassword()
        {
            ...
            _viewModel.PasswordErrorMessage = "An old error message";
        ...
        {
            var methodInfo = typeof(CustomerProfileViewModel).GetMethod("IsValidEmail", BindingFlags.NonPublic | BindingFlags.Instance);
        ...
        {
            var methodInfo = typeof(CustomerProfileViewModel).GetMethod("IsValidPhone", BindingFlags.NonPublic | BindingFlags.Instance);
